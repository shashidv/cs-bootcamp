...
flow:
  ...
  inputs:
    - host: 10.0.46.10
    - username: "CAPA1\\1038-capa1user"
    - password: Automation123
    - datacenter: Capa1 Datacenter
    - image: Ubuntu
    - folder: Students/Shashi
    - prefix_list: '1-,2-,3-'
  workflow:
    - uuid:
        do:
  ...
  graph:
    steps:
      ...
      wait_for_vm_info:
        ...
        y: 150
        navigate:
          19da07ce-d968-a66d-1a27-44fd1654af3e:
            targetId: 5a921d75-f924-b8d2-d809-da9792a804c3
            port: SUCCESS
    results:
      SUCCESS:
        5a921d75-f924-b8d2-d809-da9792a804c3:
          x: 1600
          y: 150
